...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: 'Gestionar Finca', icono:'paper', component: GestionarFincaPage },
      { title: 'Gestionar Empleados', icono:'people', component: GestionarEmpleadosPage },
      { title: 'Historial', icono:'list', component: HistorialPage }
    ];
